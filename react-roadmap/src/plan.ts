...
const plan: DayItem[] = [
  ...
  {week:5, day:35, title:"Day 35 – Object, Array",
    coding:["Validate object and array"],
    theory:[" object and array"],
    mini:["Mock session"],
    tags:["Object","Array"]},
  {week:5, day:36, title:"Day 36 –Array Methods - map, filter, reduce, Higher Order Function",
    coding:["Take problem each one of topic"],
    theory:["map, filter reduce, and explain Higher-Order Functions"],
    mini:["Mock session"],
    tags:["Array Methods","Higher Order Function"]},
  ...
  {week:5, day:44, title:"Day 44 – Http Request Error code(400, 401, 404, 500, 502)",
    coding:["3 Problems"],
