...
const plan: DayItem[] = [
  ...
  {week:4, day:30, title:"Day 30 – Final Full Mock (90 min)",
    ...
    tags:["Final","Mock"]},
  {week:5, day:31, title:"Day 31 – Real-Virtual DOM, ES6",
    coding:["Example of ES6"],
    theory:["How many things you know about JS", "ES6","Real Dom and Virtual Dom"],
    mini:["Mock session"],
    tags:["DOM","ES6"]},
  {week:5, day:32, title:"Day 32 – Web Storage-Selector",
    coding:["2 problems on storage"],
    theory:["Web Selector","Web Storage, Cookies, Session Storage, Local Storage"],
    mini:["Mock session"],
    tags:["Web Storage","Cookies"]},
  {week:5, day:33, title:"Day 33 – Client-Server Side, Multi-Single Threaded",
    coding:["1 problems"],
    theory:["Client side and Server side rendering", "JS Multithread or Single threaded"],
    mini:["Mock session"],
    tags:["Client","Server","Single-Multi Threaded"]},
  {week:5, day:34, title:"Day 34 – One-way, Two-way Binding",
    coding:["Explain in code"],
    theory:["Difference One way and Two way binding "],
    mini:["Mock session"],
    tags:["Binding","One-Two way"]},
  {week:5, day:35, title:"Day 35 – String, Object, Array",
    coding:["Validate Object and Array"],
    theory:["String", "Object", "Array"],
    mini:["Mock session"],
    tags:["String", "Object","Array"]},
  {week:5, day:36, title:"Day 36 –Array Methods, Higher Order Function",
    coding:["Take problem each one of topic"],
    theory:["Explain map, filter reduce", "Higher-Order Functions"],
    mini:["Mock session"],
    tags:["Array Methods","HOF"]},
  {week:5, day:37, title:"Day 37 - Array splice, reduce, slice, includes and find",
    coding:["Take problem each one of topic"],
    theory:["splice, reduce and slice, diff includes and find"],
    mini:["Mock session"],
    tags:["Array","Other"]},
  {week:5, day:38, title:"Day 38 – Spread operator, Deep Shallow copy",
    coding:["2 Array problems"],
    theory:["Explain template literals","Spread operator", "Deep Shallow Copy"],
    mini:["Mock session"],
    tags:["Spread operator","Deep Shallow"]},
   {week:5, day:39, title:"Day 39 – JS + Key",
    coding:["2 JS problems"],
    theory:["What is key"],
    mini:["Mock session"],
    tags:["Key","Other"]},

  {week:5, day:40, title:"Day 40 – For loop and Foreach Loop",
    coding:["For loop and Foreach Loop"],
    theory:["How many loops we're using in JS","Difference b/w for loop and foreach loop",  "Difference b/w vanilla js and js"],
    mini:["Mock session"],
    tags:["For Loops",'Vanilla JS', "Other loops"]},

  {week:5, day:41, title:"Day 41 – isNaN() function, Anonymus function",
    coding:["isNaN problem"],
    theory:["Anonymus function", "isNaN() function, how to handle exception in JS"],
    mini:["Mock session"],
    tags:["isNaN","Handle Exception"]},
  {week:5, day:42, title:"Day 42 – Event bubbling - Event propagation",
    coding:["2 problems"],
    theory:["Event bubbling", "Event propagation"],
    mini:["Mock session"],
    tags:["Event","Bubbling-Propagation"]},
  {week:5, day:43, title:"Day 43 –  404 error, CORS, proxy",
    coding:["Take 1 example"],
    theory:["How to fix 404 error? Cors issue and what is proxy"],
    mini:["Mock session"],
    tags:["Erros","Cors", 'Proxy']},
  {week:5, day:44, title:"Day 44 – Http Request Error code",
    coding:["3 Problems"],
    theory:["Http request method", "Http status message (400 bad request, 401 unauthorization, 404 not found, 500 internatl server error , 502 bad gateway)"],
    mini:["Mock session"],
    tags:["Http","Error-Handling"]},
  {week:5, day:45, title:"Day 45 – Recursive",
    coding:["2 Recursive Problems"],
    theory:["Recursive function)"],
    mini:["Mock session"],
    tags:["Recursive","Other"]},
  {week:5, day:46, title:"Day 46 – JWT",
    coding:["Explain in code"],
    theory:["Explain jwt"],
    mini:["Mock session"],
    tags:["JWT","Auth"]},
    {week:5, day:47, title:"Day 47 – Currying, Memoization",
    coding:["Explain in code"],
    theory:["Explain Currying, Memoization"],
    mini:["Mock session"],
    tags:["Currying","Memoization"]},
{week:5, day:48, title:"Day 48 – Bundler, Compiler",
    coding:["Explain in code"],
    theory:["Explain Bundler & Compiler?"],
    mini:["Mock session"],
    tags:["Bundler","Compiler"]},
    {week:5, day:49, title:"Day 49 – Synchronous, Asynchronous",
    coding:["Explain in code"],
    theory:["Difference between synchronous and asynchronous code?"],
    mini:["Mock session"],
    tags:["Sync","Async"]},
]
